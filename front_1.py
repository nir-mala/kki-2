    ...
    if latest_list:
        ...
        if unique_id and unique_id != st.session_state.last_id:
            ...
            if reset_code == "0125":
                ...
                files_to_delete = files_to_delete = ["images/sbox1.jpg", "images/ubox1.jpg"]
...
def posisi_floating_ball(path):
    if path == "A":
        green_positions = [(355, 960), (355, 1310), (475, 1715), (1040, 2275), (1200, 2275),
                         (1360, 2275), (1520, 2275), (2350, 1465), (2205, 1160), (2285, 855)]
        red_positions = [(155, 960), (155, 1310), (275, 1715), (1040, 2075), (1200, 2075),
                           (1360, 2075), (1520, 2075), (2150, 1465), (2005, 1160), (2085, 855)]
    elif path == "B":
        red_positions = [(415, 855), (495, 1160), (350, 1465), (980, 2075), (1140, 2075),
                         (1300, 2075), (1460, 2075), (2225, 1715), (2345, 1310), (2345, 960)]
        green_positions = [(215, 855), (295, 1160), (150, 1465), (980, 2275), (1140, 2275),
                           (1300, 2275), (1460, 2275), (2025, 1715), (2145, 1310), (2145, 960)]
...
with part2:
    ...
    checkpoints_A = [
        ...
        (1435, 1585, 2000, 2400),      # B4
        (1300, 1435, 2000, 2400),     # B5
        (1085, 1300, 2000, 2400),     # B6
        (985, 1085, 2000, 2400),  
        (250, 450, 1500, 2000),     # B8
        (150, 350, 1000, 1400),     # B9
        (180, 280, 800, 1100),      # B10
    ]
