...
def posisi_floating_ball(path):
    if path == "A":
        green_positions = [(330, 960), (330, 1310), (475, 1715), (1040, 2275), (1200, 2275),
                         (1360, 2275), (1520, 2275), (2325, 1465), (2180, 1160), (2260, 855)]
        red_positions = [(180, 960), (180, 1310), (275, 1715), (1040, 2075), (1200, 2075),
                           (1360, 2075), (1520, 2075), (2175, 1465), (2030, 1160), (2110, 855)]
    elif path == "B":
